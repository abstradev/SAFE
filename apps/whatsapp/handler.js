...
module.exports = (SafeHandler) => {
  ...
  const useragent = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.128 Safari/537.36';
  SafeHandler.setUserAgent(useragent.replace(/(safe|Electron)([^\s]+\s)/g, ''));
